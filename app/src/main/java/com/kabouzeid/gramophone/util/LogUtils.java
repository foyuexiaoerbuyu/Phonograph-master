...
public class LogUtils {
    ...
    private static void showLogInfo(String tag, String level, String output, String message) {
        switch (level) {
            case "i":
                android.util.Log.i(TAG, output + "  " + message);
                break;
            case "d":
                android.util.Log.d(TAG, output + "  " + message);
                break;
            case "v":
                android.util.Log.v(TAG, output + "  " + message);
                break;
            case "w":
                android.util.Log.w(TAG, output + "  " + message);
                break;
            case "e":
                android.util.Log.e(TAG, output + "  " + message);
                break;
            case "json":
                String msg;
                try {
                ...
                for (String line : lines) {
                    android.util.Log.e(TAG, output + " ║ " + line);
                }
